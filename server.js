...
// 設定靜態檔案服務 (如果您的前端檔案在 `public` 或 `build` 目錄)
// 如果您的前端是單獨部署的，這部分可以移除或調整
// 例如，如果您的前端在 `client/build`，則路徑會是 `path.join(__dirname, '../client/build')`
// 這裡假設您的前端靜態檔案在後端專案根目錄下的 `public` 資料夾
